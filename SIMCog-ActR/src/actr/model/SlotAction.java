...
class SlotAction {
	...
	void fire(Instantiation inst, Chunk bufferChunk) {
		...
		if (operator == null)
			...
			bufferChunk.addRequestCondition(new SlotCondition(operator, realSlot,
					realValue, model));
		// TEH Changed the third arg to addRequestCondition from value to realValue, and slot to realSlot
	}
