...
{\bf\textsc{Task Specific Recommendation for Information Presentation}\vspace{0.5em}} % Poster title
{\textsc{\{ Liang Dong, Robert St. Amant \} \hspace{12pt} North Carolina State University}} % Author names and institution
...
\headerbox{Visual Design}{name=objectives,column=0,row=0}{
...
\headerbox{Cognitive Model}{name=introduction,column=1,row=0,bottomaligned=objectives}{
...
\headerbox{Graphical Perception}{name=results,column=2,span=2,row=0}{
...
\headerbox{Pilot Study}{name=references,column=0,above=bottom}{
...
\headerbox{Framework}{name=conclusion,column=2,span=2,row=0,below=results,above=references}{
...
\headerbox{Methods}{name=method,column=0,below=objectives,bottomaligned=conclusion}{ % This block's bottom aligns with the bottom of the conclusion block
