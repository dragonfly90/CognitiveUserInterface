...
setTimeout(function(){
  ...
  //screen object declaration here. specification in documentation.
    ...
    {type : "Line", id : "management_tank_0_target_left", change : "static"},
        {type : "Line", id : "management_tank_0_target_right", change : "static"},

    {type : "Line", id : "management_tank_1_target_left", change : "static"},
        {type : "Line", id : {name : "management_tank_1_target_right", domLocation: d3.selectAll("#management_tank_0_target_right")[0][1]}, change : "static"},

    {type : "RectangleOutline", id : {domLocation:d3.select("#management_tank_0_resource")[0][0].parentElement.lastElementChild, name:"management_tank_0_resource_tank_frame"}, change : "static"},
      {type : "RectangleOutline", id : {domLocation:d3.select("#management_tank_1_resource")[0][0].parentElement.lastElementChild, name:"management_tank_1_resource_tank_frame"}, change : "static"}, 
        {type : "RectangleOutline", id : {domLocation:d3.select("#management_tank_2_resource")[0][0].parentElement.lastElementChild, name:"management_tank_2_resource_tank_frame"}, change : "static"},
          {type : "RectangleOutline", id : {domLocation:d3.select("#management_tank_3_resource")[0][0].parentElement.lastElementChild, name:"management_tank_3_resource_tank_frame"}, change : "static"},


    {type : "Line", id : "monitor_centerline_0", change : "static"},
      {type : "Line", id : "monitor_centerline_1", change : "static"},
        {type : "Line", id : "monitor_centerline_2", change : "static"},
          {type : "Line", id : "monitor_centerline_3", change : "static"},


    {type : "Line" , id: "monitor_slider_0_tick_0", change: "static"}, 
      {type : "Line" , id: "monitor_slider_0_tick_1", change: "static"},
        {type : "Line" , id: "monitor_slider_0_tick_2", change: "static"},
          {type : "Line" , id: "monitor_slider_0_tick_3", change: "static"},
            {type : "Line" , id: "monitor_slider_0_tick_4", change: "static"},
              {type : "Line" , id: "monitor_slider_0_tick_5", change: "static"},
                {type : "Line" , id: "monitor_slider_0_tick_6", change: "static"},

    {type : "Line" , id: "monitor_slider_1_tick_0", change: "static"},
      {type : "Line" , id: "monitor_slider_1_tick_1", change: "static"},
        {type : "Line" , id: "monitor_slider_1_tick_2", change: "static"},
          {type : "Line" , id: "monitor_slider_1_tick_3", change: "static"},
            {type : "Line" , id: "monitor_slider_1_tick_4", change: "static"},
              {type : "Line" , id: "monitor_slider_1_tick_5", change: "static"},
                {type : "Line" , id: "monitor_slider_1_tick_6", change: "static"},

    {type : "Line" , id: "monitor_slider_2_tick_0", change: "static"},
      {type : "Line" , id: "monitor_slider_2_tick_1", change: "static"},
        {type : "Line" , id: "monitor_slider_2_tick_2", change: "static"},
          {type : "Line" , id: "monitor_slider_2_tick_3", change: "static"},
            {type : "Line" , id: "monitor_slider_2_tick_4", change: "static"},
              {type : "Line" , id: "monitor_slider_2_tick_5", change: "static"},
                {type : "Line" , id: "monitor_slider_2_tick_6", change: "static"},

    {type : "Line" , id: "monitor_slider_3_tick_0", change: "static"},
      {type : "Line" , id: "monitor_slider_3_tick_1", change: "static"},
        {type : "Line" , id: "monitor_slider_3_tick_2", change: "static"},
          {type : "Line" , id: "monitor_slider_3_tick_3", change: "static"},
            {type : "Line" , id: "monitor_slider_3_tick_4", change: "static"},
              {type : "Line" , id: "monitor_slider_3_tick_5", change: "static"},
                {type : "Line" , id: "monitor_slider_3_tick_6", change: "static"},

    {type : "Label", id : "comm_target_name", change : ["evt","color","stringVal"]},
      {type : "Label", id : "comm_target_frequency", change : ["evt","color","stringVal"]},

    {type : "Rectangle", id : "comm_target_rect", change : "static"},


    {type : "Label", id : "comm_channel_0_name", change : "static"},
      {type : "Label", id : "comm_channel_1_name", change : "static"},
        {type : "Label", id : "comm_channel_2_name", change : "static"},
          {type : "Label", id : "comm_channel_3_name", change : "static"},

    {type : "Label", id : "comm_channel_0_frequency"},
      {type : "Label", id : "comm_channel_1_frequency", change : ["stringVal"]},
        {type : "Label", id : "comm_channel_2_frequency", change : ["stringVal"]},
            {type : "Label", id : "comm_channel_3_frequency", change : ["stringVal"]},

    //{type : "Rectangle", id : "monitor_slider_0", change : ["y"]},
      // {type : "Rectangle", id : "monitor_slider_1", change : ["y"]},
      //  {type : "Rectangle", id : "monitor_slider_2", change : ["y"]},
      //    {type : "Rectangle", id : "monitor_slider_3", change : ["y"]},


    // {type : "Rectangle", id : "management_tank_0_resource", change : ["y","height"]},
    //  {type : "Rectangle", id : "management_tank_1_resource", change : ["y","height"]},
    //    {type : "Rectangle", id : "management_tank_2_resource", change : ["y","height"]},
    //      {type : "Rectangle", id : "management_tank_3_resource", change : ["y","height"]},

    {type : "RectangleOutlineFill", id : "resource_switch_0", change : ["evt","color","secondaryColor"]},
      {type : "RectangleOutlineFill", id : "resource_switch_1", change : ["evt","color","secondaryColor"]},
        {type : "RectangleOutlineFill", id : "resource_switch_2", change : ["evt","color","secondaryColor"]},
          {type : "RectangleOutlineFill", id : "resource_switch_3", change : ["evt","color","secondaryColor"]},
            {type : "RectangleOutlineFill", id : "resource_switch_4", change : ["evt","color","secondaryColor"]},
              {type : "RectangleOutlineFill", id : "resource_switch_5", change : ["evt","color","secondaryColor"]},
                {type : "RectangleOutlineFill", id : "resource_switch_6", change : ["evt","color","secondaryColor"]},
                  {type : "RectangleOutlineFill", id : "resource_switch_7", change : ["evt","color","secondaryColor"]},

    {type : "Rectangle", id : "monitor_button_0", change : ["evt","color"]}, //Newer inline styles in chrome.
      {type : "Rectangle", id : "monitor_button_1", change : ["evt","color"]},


    {type : "OvalOutlineFill", id :"resource_generator_0", change : "static"},
      {type : "OvalOutlineFill", id : "resource_generator_1", change : "static"},
   
    {type : "OvalOutlineFill", id : "track_circle_0", change : ["poll","x","y","color"], clickable : true},
      {type : "OvalOutlineFill", id : "track_circle_1", change : ["poll","x","y","color"], clickable : true},
        {type : "OvalOutlineFill", id : "track_circle_2", change : ["poll","x","y","color"] ,clickable : true},
    
    {type : "RectangleOutlineFill", id : "comm_channel_0_rect", change : ["secondaryColor"]}, //Class "" means it has no class so its undefined.
      {type : "RectangleOutlineFill", id : "comm_channel_1_rect", change : ["secondaryColor"]},
        {type : "RectangleOutlineFill", id : "comm_channel_2_rect", change : ["secondaryColor"]},
          {type : "RectangleOutlineFill", id : "comm_channel_3_rect", change : ["secondaryColor"]},

    {type : "OvalOutline", id : {name:"middleTrackCircle",domLocation:d3.select("circle")[0][0]}, change : "static"},

    {type : "Rectangle", id : {name : "svg0", domLocation: d3.selectAll("svg")[0][0].firstChild.firstChild}, change : "static", taskRelevant : false},
      {type : "Rectangle", id : {name : "svg1", domLocation: d3.selectAll("svg")[0][1].firstChild.firstChild}, change : "static", taskRelevant : false},
        {type : "Rectangle", id : {name : "svg2", domLocation: d3.selectAll("svg")[0][2].firstChild.firstChild}, change : "static", taskRelevant : false}, //Task irrelevant lines will default to rectangles
          {type : "Rectangle", id : {name : "svg3", domLocation: d3.selectAll("svg")[0][3].firstChild.firstChild}, change : "static", taskRelevant : false}
...
//////////// Light goals
	console.log("******* Monitor button probability: " + monitor_data.buttons[0].prob + "\n");
 if(monitor_data.buttons[0].prob == 1){
 ...
 if(monitor_data.buttons[1].prob == 1){
   var tmp = getObjectXYHW("monitor_button_1");
   var string = "(add-dm (monitorRedGoal isa goal task monitor-red xMin ";
   string += Math.floor(tmp.x);
   string += " xMax ";
   string += Math.ceil(tmp.x + tmp.width);
   string += " yMin ";
   ...
   string += "))";
   modelCommands.push(string);
   modelCommands.push("(goal-focus monitorRedGoal)");
 }
////////////// Slider goals
//  if(monitor_data.scales[0].prob == 1){
//    var tmp1 = getObjectXYHW("monitor_centerline_0");
//    var tmp2 = getObjectXYHW("monitor_slider_0_tick_2");
//    var tmp3 = getObjectXYHW("monitor_slider_0_tick_4")
//    var string = "(add-dm (monitorSlider0Goal isa goal task monitor-slider0 xMin ";
//    string += Math.floor(tmp2.x - tmp2.width);
//    string += " xMax ";
//    string += Math.ceil(tmp2.x);
//    string += " yMin ";
//    string += Math.floor(tmp1.y);
//    string += " yMax ";
//    string += Math.ceil(tmp1.y + tmp1.height);
//    string += " gaugeMin ";
//    string += Math.floor(tmp3.y);
//    string += " gaugeMax ";
//    string += Math.ceil(tmp2.y);
//    string += "))";
//    modelCommands.push(string);
//    modelCommands.push("(goal-focus monitorSlider0Goal)");
//  }
//  if(monitor_data.scales[1].prob == 1){
//    var tmp1 = getObjectXYHW("monitor_centerline_1");
//    var tmp2 = getObjectXYHW("monitor_slider_1_tick_2");
//    var tmp3 = getObjectXYHW("monitor_slider_1_tick_4")
//    var string = "(add-dm (monitorSlider1Goal isa goal task monitor-slider1 xMin ";
//    string += Math.floor(tmp2.x - tmp2.width);
//    string += " xMax ";
//    string += Math.ceil(tmp2.x);
//    string += " yMin ";
...
//    string += "))";
//    modelCommands.push(string);
//    modelCommands.push("(goal-focus monitorSlider1Goal)");
//  }
//  if(monitor_data.scales[2].prob == 1){
//    var tmp1 = getObjectXYHW("monitor_centerline_2");
//    var tmp2 = getObjectXYHW("monitor_slider_2_tick_2");
//    var tmp3 = getObjectXYHW("monitor_slider_2_tick_4")
//    var string = "(add-dm (monitorSlider2Goal isa goal task monitor-slider2 xMin ";
//    string += Math.floor(tmp2.x - tmp2.width);
//    string += " xMax ";
//    string += Math.ceil(tmp2.x);
//    string += " yMin ";
...
//    string += "))";
//    modelCommands.push(string);
//    modelCommands.push("(goal-focus monitorSlider2Goal)");
//  }
//  if(monitor_data.scales[3].prob == 1){
//    var tmp1 = getObjectXYHW("monitor_centerline_3");
//    var tmp2 = getObjectXYHW("monitor_slider_3_tick_2");
//    var tmp3 = getObjectXYHW("monitor_slider_3_tick_4")
//    var string = "(add-dm (monitorSlider3Goal isa goal task monitor-slider3 xMin ";
//    string += Math.floor(tmp2.x - tmp2.width);
//    string += " xMax ";
//    string += Math.ceil(tmp2.x);
//    string += " yMin ";
...
//    string += "))";
//    modelCommands.push(string);
//    modelCommands.push("(goal-focus monitorSlider3Goal)");
//  }
//////////// Tracking goal
	console.log("******* Tracking probability: " + track_chart.prob + "\n");
	//	TEH: track_chart.totalProb is undefined at start.
	//	So I used track_data.orbits[0].prob == 1
//   if(track_data.orbits[0].prob == 1){
//     var tmp = getObjectXYHW(d3.selectAll("svg")[0][1].firstChild);
//     var string = "(add-dm (trackingTask isa goal task tracking xMin ";
//     string += Math.floor(tmp.x);
//     string += " xMax ";
//     string += Math.ceil(tmp.x + tmp.width);
//     string += " yMin ";
...
//     string += "))";
//     modelCommands.push(string);
//     modelCommands.push("(goal-focus trackingTask)");
//   }
// //////////// Comm goal
// 	console.log("******* Comm task probability: " + comm_chart.totalProb + "\n");
// 	if(comm_chart.totalProb > 0){
// 	  var tmp = getObjectXYHW(d3.selectAll("svg")[0][2].firstChild);
// 	  var string = "(add-dm (commTask isa goal task comm xMin ";
// 	  string += Math.floor(tmp.x);
// 	  string += " xMax ";
// 	  string += Math.ceil(tmp.x + tmp.width);
// 	  string += " yMin ";
...
// 	  string += "))";
// 	  modelCommands.push(string);
// 	  modelCommands.push("(goal-focus commTask)");
// 	}
// //////////// Resource goal
// 	console.log("******* Resource task probability: " + comm_chart.totalProb + "\n");
// 	if(resource_chart.totalProb > 0){
// 	var tmp = getObjectXYHW(d3.selectAll("svg")[0][3].firstChild);
// 	var string = "(add-dm (resourceTask isa goal task resource xMin ";
// 	string += Math.floor(tmp.x);
// 	string += " xMax ";
// 	string += Math.ceil(tmp.x + tmp.width);
// 	string += " yMin ";
...
// 	string += "))";
// 	modelCommands.push(string);
// 	modelCommands.push("(goal-focus resourceTask)");
//	}
}
...
ws.onopen = function() {
  ...
  //If you wanted to manually specify an object for some reason do that here. IE objects not in page.
    ...
    var s0 = getObjectXYHW("monitor_slider_0");
    intialArray.push({id:"monitor_slider_0", type:"Rectangle", color:"white", x:s0.x,y:s0.y + (s0.height / 2),width:s0.width, height: 1});

    var s0 = getObjectXYHW("monitor_slider_1");
    intialArray.push({id:"monitor_slider_1", type:"Rectangle", color:"white", x:s0.x,y:s0.y + (s0.height / 2),width:s0.width, height: 1});

    var s0 = getObjectXYHW("monitor_slider_2");
    intialArray.push({id:"monitor_slider_2", type:"Rectangle", color:"white", x:s0.x,y:s0.y + (s0.height / 2),width:s0.width, height: 1});

    var s0 = getObjectXYHW("monitor_slider_3");
    intialArray.push({id:"monitor_slider_3", type:"Rectangle", color:"white", x:s0.x,y:s0.y + (s0.height / 2),width:s0.width, height: 1});

    var r0 = getObjectXYHW("management_tank_0_resource");
    intialArray.push({id:"management_tank_0_resource",type:"Rectangle",color:"yellow green",x:r0.x,y:r0.y,width:r0.width,height:1});
    var r0 = getObjectXYHW("management_tank_1_resource");
    intialArray.push({id:"management_tank_1_resource",type:"Rectangle",color:"yellow green",x:r0.x,y:r0.y,width:r0.width,height:1});
    var r0 = getObjectXYHW("management_tank_2_resource");
    intialArray.push({id:"management_tank_2_resource",type:"Rectangle",color:"yellow green",x:r0.x,y:r0.y,width:r0.width,height:1});
    var r0 = getObjectXYHW("management_tank_3_resource");
    intialArray.push({id:"management_tank_3_resource",type:"Rectangle",color:"yellow green",x:r0.x,y:r0.y,width:r0.width,height:1});
...
var intervalFunction = function(dynamicItems){
    setInterval(function() {
      ...
      //If you wanted to manually update items you specified in the init that would be done here.
      var s0 = getObjectXYHW("monitor_slider_0");
      updateArray.push({id:"monitor_slider_0", type:"Rectangle", x:s0.x,y:s0.y + (s0.height / 2),width:s0.width, height: 1});
      var s0 = getObjectXYHW("monitor_slider_1");
      updateArray.push({id:"monitor_slider_1", type:"Rectangle", x:s0.x,y:s0.y + (s0.height / 2),width:s0.width, height: 1});
      var s0 = getObjectXYHW("monitor_slider_2");
      updateArray.push({id:"monitor_slider_2", type:"Rectangle", x:s0.x,y:s0.y + (s0.height / 2),width:s0.width, height: 1});
      var s0 = getObjectXYHW("monitor_slider_3");
      updateArray.push({id:"monitor_slider_3", type:"Rectangle", x:s0.x,y:s0.y + (s0.height / 2),width:s0.width, height: 1});

      var r0 = getObjectXYHW("management_tank_0_resource");
      updateArray.push({id:"management_tank_0_resource",type:"Rectangle",y:r0.y});
      var r0 = getObjectXYHW("management_tank_1_resource");
      updateArray.push({id:"management_tank_1_resource",type:"Rectangle",y:r0.y});
      var r0 = getObjectXYHW("management_tank_2_resource");
      updateArray.push({id:"management_tank_2_resource",type:"Rectangle",y:r0.y});
      var r0 = getObjectXYHW("management_tank_3_resource");
      updateArray.push({id:"management_tank_3_resource",type:"Rectangle",y:r0.y});
